  ...
  return (
    <div>
      ...
      <div className="mx-4 sm:mx-12 lg:mx-24 overflow-x-auto relative shadow-md sm:rounded-lg">
        <Projecttable />
        {/* <!-- Edit user modal --> */}
        <div id="editUserModal" tabindex="-1" aria-hidden="true" className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center p-4 w-full md:inset-0 h-modal md:h-full">
